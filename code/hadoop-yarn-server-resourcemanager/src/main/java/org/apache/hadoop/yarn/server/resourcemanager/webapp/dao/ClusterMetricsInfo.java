...
public class ClusterMetricsInfo {
  private static final Log LOG = LogFactory.getLog(ClusterMetricsInfo.class);
...
//    LOG.info("MyLOG:\t Cluster Come up!!! Total".concat(String.valueOf(totalMB)));
//    LOG.info("MyLOG:\t Cluster Come up!!! Av2ail".concat(String.valueOf(availableMB)));
//    LOG.info("MyLOG:\t Cluster Come up!!! Allocated".concat(String.valueOf(allocatedMB)));
...
//    LOG.info("MyLOG:\t getTotalMB  ".concat(String.valueOf(totalMB)));
    return this.totalMB;
  }
