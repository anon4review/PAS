...
public class FiCaSchedulerApp extends SchedulerApplicationAttempt {
  ...
  private long addActiveSetTimestamp = System.nanoTime();
  ...
  /*********************************************************************/
  public long getAddActiveSetTimestamp() {
    return addActiveSetTimestamp;
  }

  public void setAddActiveSetTimestamp(long addActiveSetTimestamp) {
    this.addActiveSetTimestamp = addActiveSetTimestamp;
  }
}
